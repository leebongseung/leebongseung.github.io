...
| 3종류 조합 | `Digits / Lowercase / Uppercase / Special` | ✅ |
| 주기적 변경 | `Expire Password` | ✅ |
...
| **Not Contains Username** | username **부분 포함** 차단 (`gildong123` 같은 변형 차단) | 기본 `Not Username` 은 *완전 일치* 만 차단 |
